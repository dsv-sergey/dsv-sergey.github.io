...
var storage = function () {
    ...
    return {
        addNote: function addNote(typeData, text, methodSend) {
            if (methodSend == "XHR") {
        ...
        overwritingMessages: function overwritingMessages(typeData, text, methodSend) {
            if (methodSend == "XHR") {
                var xhttp = new XMLHttpRequest();
        ...
        getNote: function getNote(typeData, id, methodSend) {
            if (methodSend == "XHR") {
                var xhttp = new XMLHttpRequest();
        ...
        getAllNotes: function getAllNotes(typeData, id, methodSend) {
            if (methodSend == "XHR") {} else if (methodSend == "fetch") {
        ...
        delete: function _delete(type, id, method) {
            if (method == "XHR") {} else if (method == "fetch") {
                fetch(databaseURL + "/.json", {
                    headers: {
                        Accept: "application/json",
                        "Content-Type": "application/json"
